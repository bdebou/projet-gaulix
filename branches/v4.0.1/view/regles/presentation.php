...
<p>
	...
	Vous incarnez un gaulois qui doit survivre et évoluer.
</p>
...
<p>Vous aurez plusieurs d'actions possible en fonction de votre niveau, compétences acquises, ... (voir <a href="#" onclick="javascript:change_onglet('compétences');">Compétences</a>).</p>
<p>
	<img src="img/presentation/actions.png" alt="Actions" title="Exemple d'actions" style="float:left;" />
	Comme dans cette exemple, vous pouvez attaquer un autre joueur (<img src="img/homme-grey.png" alt="Autre joueur" title="Gaulois ZUT" height="20px" />) et vous prourriez construire un bâtiment.
</p>
