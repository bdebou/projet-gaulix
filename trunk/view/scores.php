...
foreach($lignes as $ligne){
	echo '
		<tr>'
			...
			.'<td><img alt="Barre d\'expérience" src="./fct/fct_image.php?type=experience&amp;value='.$ligne['experience'].'&amp;max='.(($ligne['niveau'] + 1) * 100).'&amp;taille=140x20" /></td>'
			.'<td><img alt="Barre de Vie" src="./fct/fct_image.php?type=vie&amp;value='.$ligne['vie'].'&amp;max='.personnage::VIE_MAX.'&amp;taille=140x20" /></td>'
